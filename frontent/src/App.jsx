...
export default function App() {
  ...
  return <><AppHeader onHome={() => { setSettingsOpen(false); tasklane.showProjects(); }} />{tasklane.error && <p className="app-error" role="alert">{tasklane.error}</p>}{tasklane.project
    ? isSettingsOpen ? <ProjectSettingsPage project={tasklane.project} onBack={() => setSettingsOpen(false)} onSave={tasklane.updateProject} /> : <BoardPage project={tasklane.project} onBack={tasklane.showProjects} onRefresh={tasklane.refreshBoard} onSettings={() => setSettingsOpen(true)} />
